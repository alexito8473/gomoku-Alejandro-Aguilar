...
//almeria
	 ...
	 */
	private static void jugdorReal(ficha ficha) {
		do {
			letra();
			numero();
	...
	/**
	 * Metodo donde se realiza todas las instrucciones necesarias del pintar el tablero 
	 * @param ficha Tipo ficha
	 */
	private static void pintar(ficha ficha) {
